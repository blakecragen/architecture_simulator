"""
ARM AArch64 multi-cycle (FetDecExe) preset.

Same multi-cycle structure as RISC-V but with ARM decoder,
FlagsRegister, and 32-reg file with zero register at index 31.
"""
...
def build(
    ...
    # ── Branch Resolution (reads from flags register) ────────────
