"""ARM AArch64 configurable cycle-cost preset ("Configurable" model).

Same combinational datapath as ARM single-cycle, but each instruction is held
...
the single-cycle oracle. See sim/isa/arm/presets/single_cycle.py.
"""
